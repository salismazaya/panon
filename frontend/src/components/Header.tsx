    ...
    return (
        <header className="absolute top-0 right-0 left-80 h-20 border-b-4 border-black flex items-center justify-between px-8 z-20 bg-white pointer-events-auto">
            ...
            <div className="flex items-center gap-8">
                ...
                <div className="flex items-center gap-3 px-4 py-2 border-2 border-black bg-slate-50">
            ...
            <div className="flex items-center gap-4">
                {/* Mode Toggle */}
                <div className="flex items-center border-[3px] border-black bg-white p-0.5 shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]">
                ...
                <div className="flex items-center gap-2">
                    <button
                        ...
                        className={`flex items-center gap-2 px-4 py-2 border-[3px] border-black text-xs font-black uppercase transition-all ${isValid && !isSaving
                    ...
                    <button
                        ...
                        disabled={!isValid}
                        className={`flex items-center gap-2 px-4 py-2 border-[3px] border-black text-xs font-black uppercase transition-all ${isValid
                ...
                {/* Sync Status Badge */}
                <div className="flex items-center gap-2 px-3 py-2 border-[3px] border-black text-[10px] font-black uppercase bg-white shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]">
                    {isSaving ? (
                        <>
                ...
                <button
                    ...
                    className="flex items-center justify-center p-2.5 border-[3px] border-black bg-white hover:bg-slate-50 shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[-1px] hover:translate-y-[-1px] transition-all ml-2"
